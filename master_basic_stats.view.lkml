...
view: master_stats {
  ...
  {% if (ad._in_query or master_stats.creative_id._in_query) %}
    mw_adwords_analytics.AdBasicStats_9471847904
  {% elsif (audience._in_query or master_stats.audience_criterion_id._in_query) %}
    mw_adwords_analytics.AudienceBasicStats_9471847904
  {% elsif (keyword._in_query or master_stats.criteria_id._in_query) %}
    mw_adwords_analytics.KeywordBasicStats_9471847904
  {% elsif (ad_group._in_query or master_stats.ad_group_id._in_query) %}
    {% if master_stats.hour_of_day._in_query %}
      mw_adwords_analytics.HourlyAdGroupStats_9471847904
    {% else %}
      mw_adwords_analytics.AdGroupBasicStats_9471847904
    {% endif %}
  {% elsif (campaign._in_query or master_stats.campaign_id._in_query) %}
    {% if master_stats.hour_of_day._in_query %}
      mw_adwords_analytics.HourlyCampaignStats_9471847904
    {% else %}
      mw_adwords_analytics.CampaignBasicStats_9471847904
    {% endif %}
  {% else %}
    {% if master_stats.hour_of_day._in_query %}
      mw_adwords_analytics.HourlyAccountStats_9471847904
    {% else %}
      mw_adwords_analytics.AccountBasicStats_9471847904
    {% endif %}
  {% endif %} ;;
